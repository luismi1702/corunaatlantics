...
ORDEN = ['01_schema.sql', '02_rls.sql', '04_tesoreria.sql',
         ...
         '13_permisos_funciones.sql', '14_tienda.sql', '15_competiciones.sql', '16_estadisticas_visibles.sql', '17_permisos.sql', '18_capitanes.sql', '19_tienda_cierre.sql', '20_cobro_directo.sql', '21_companeros_aprobados.sql', '22_push.sql']
